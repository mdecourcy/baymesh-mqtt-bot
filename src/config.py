...
def _build_settings() -> Settings:
    return Settings(
        ...
        subscription_send_hour=_get_int("SUBSCRIPTION_SEND_HOUR", default=9, min_value=0, max_value=23),
        subscription_send_minute=_get_int("SUBSCRIPTION_SEND_MINUTE", default=0, min_value=0, max_value=59),
        log_level=os.getenv("LOG_LEVEL", "INFO").upper(),
        log_retention_days=_get_int("LOG_RETENTION_DAYS", default=7, min_value=1, max_value=365),
        meshtastic_connection_url=os.getenv("MESHTASTIC_CONNECTION_URL"),
        meshtastic_commands_enabled=_get_bool("MESHTASTIC_COMMANDS_ENABLED", default=False),
        ...
        meshtastic_include_default_key=_get_bool("MESHTASTIC_INCLUDE_DEFAULT_KEY", default=True),
        meshtastic_default_key=os.getenv("MESHTASTIC_DEFAULT_KEY"),
        meshtastic_rate_limit_seconds=_get_int("MESHTASTIC_RATE_LIMIT_SECONDS", default=10, min_value=1, max_value=300),
        meshtastic_rate_limit_burst=_get_int("MESHTASTIC_RATE_LIMIT_BURST", default=3, min_value=1, max_value=10),
        daily_broadcast_enabled=_get_bool("DAILY_BROADCAST_ENABLED", default=False),
        daily_broadcast_hour=_get_int("DAILY_BROADCAST_HOUR", default=21, min_value=0, max_value=23),
        daily_broadcast_minute=_get_int("DAILY_BROADCAST_MINUTE", default=0, min_value=0, max_value=59),
        daily_broadcast_channel=_get_int("DAILY_BROADCAST_CHANNEL", default=0, min_value=0, max_value=7),
        router_inactivity_alerts_enabled=_get_bool("ROUTER_INACTIVITY_ALERTS_ENABLED", default=False),
        router_inactivity_threshold_minutes=_get_int("ROUTER_INACTIVITY_THRESHOLD_MINUTES", default=60, min_value=5, max_value=1440),
        router_inactivity_check_interval_minutes=_get_int("ROUTER_INACTIVITY_CHECK_INTERVAL_MINUTES", default=15, min_value=5, max_value=60),
        router_inactivity_alert_channel=_get_int("ROUTER_INACTIVITY_ALERT_CHANNEL", default=0, min_value=0, max_value=7),
    )
